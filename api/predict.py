...
# @predict_blueprint.route('/predictions',methods=["POST"])
...
#     for i in user_ref:
#         i.reference.update({"predictions":[{"date":datetime.today().strftime('%Y-%m-%d'), "res":output, "fertilizer":response}]}) # get the document reference and use it to update\delete ...
